The following entities are accessible through the DevRev [public API](https://devrev.ai/docs/apis/methods).
...
For more information about security tokens, refer to [Authentication](./authentication).
...
Work items DevRev objects have a timeline that contain discussions and events. Discussions are comments added by a person or a bot, while events indicate a change of the object’s state.
