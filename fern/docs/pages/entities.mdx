...
For more information for about authentication connections, refer to [External identity provider setup](/product/sso-saml).
...
For more information about security tokens, refer to [Authentication](/apis/auth).
...
For more information about parts, refer to [Parts & trails](/product/parts).
...
For more information about webhooks, refer to [Getting started with webhooks](/webhooks/getting-started).
...
For more information about work items, refer to [Tickets](/product/tickets) and [Issues](/product/issues).