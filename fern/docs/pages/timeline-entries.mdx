...
The [timeline entries](/apis/entities#discussions-and-events-timelineentries) API is used to create discussions (comments) on the timeline of an object such as a ticket or issue. These messages can be sent by users or by a bot.
