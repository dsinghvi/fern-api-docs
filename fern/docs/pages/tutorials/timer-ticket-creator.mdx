...
- [Getting Started](/snap-in-development/tutorials/getting-started): Deploying a snap-in
  to your dev org.
...
The [Getting Started](/snap-in-development/tutorials/getting-started) section shows a
...
[Event Sources](/snap-in-development/references/event-sources)
section in the manifest. The [`timer-events`](/snap-in-development/references/event-sources#timer-based-event-sources)
...
As discussed in the [Getting Started](/snap-in-development/tutorials/getting-started),
...
[documentation](/snap-in-development/references/event-sources#timer-based-event-sources).
...
[Getting Started](/snap-in-development/tutorials/getting-started) section.
