...
- [Getting Started](/welcome/snap-in-development/tutorials/getting-started): Deploying a snap-in
  to your dev org.
...
The [Getting Started](/welcome/snap-in-development/tutorials/getting-started) section shows a
...
[Event Sources](/welcome/snap-in-development/references/event-sources)
section in the manifest. The [`timer-events`](/welcome/snap-in-development/references/event-sources#timer-based-event-sources)
...
As discussed in the [Getting Started](/welcome/snap-in-development/tutorials/getting-started),
...
[documentation](/welcome/snap-in-development/references/event-sources#timer-based-event-sources).
...
[Getting Started](/welcome/snap-in-development/tutorials/getting-started) section.
