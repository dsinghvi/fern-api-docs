...
- [Getting Started](/snap-in-development/tutorials/getting-started)
...
2. **Secrets and keyrings in DevRev snap-ins:**
   ...
   - Explore the usage of secrets and refer to
     [keyrings](/snap-in-development/references/keyrings) in DevRev snap-ins.

3. **Command creation and utilization in DevRev:**
   - Gain proficiency in creating and using
     [commands](/snap-in-development/references/commands) in DevRev.
...
[connection](/snap-in-development/references/keyrings) within DevRev. Subsequently, this
