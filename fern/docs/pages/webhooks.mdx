...
![sequence diagram](../img/diagram_4.png)
...
3. Register webhook endpoint
   ...
   DevRev as the originator.
     ...
     [API Reference: Create Webhook](https://developer.devrev.ai/public/welcome/ap-is-and-webhooks/dev-rev-rest-api/api-reference/webhooks/create)
