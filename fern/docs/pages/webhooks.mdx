...
![diagram_4](https://github.com/devrev/fern-api-docs/assets/74637789/8c950f32-0ad3-4c9b-9597-1a283134a195)

## Webhook event handling

<a href="https://devrev.ai/docs/apis/methods#/schemas/webhook-event-request">
...
3. Register webhook endpoint
   ...
   DevRev as the originator.
     ...
     [API Reference: Create Webhook](/welcome/ap-is-and-webhooks/dev-rev-rest-api/api-reference/webhooks/create)
