...
Specifications covering the supported APIs are based on OpenAPI Specification 3.0. You can download the specs to use an OpenAPI 3.0-compliant tool to perform a variety of actions, including rendering them in UI and generating SDKs. Two [versions](../apis/versioning) of the DevRev API are available: [public](https://devrev.ai/docs/apis/methods) and [early access/beta](https://devrev.ai/docs/apis/beta-api-spec). Descriptions of the public [entities](../apis/entities) are available.
