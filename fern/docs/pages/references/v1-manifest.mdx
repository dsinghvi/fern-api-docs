...
For a complete reference to supported global types, refer to the [DevRev documentation](https://devrev.ai/docs/apis/beta-api-spec#/schemas/schema-field-descriptor).
