...
<Video>
  url="https://www.youtube.com/embed/5W70bbHxEJU"
  title="🎥 Video: View Snap-in logs via DevRev CLI"
</Video>
...
### snap_in draft command returns: "You are not authorized to perform this operation"
