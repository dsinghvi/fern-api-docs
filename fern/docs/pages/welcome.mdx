...
If you're new to DevRev APIs, you've come to the right place. Our APIs serve as the foundation for integrating your apps, building automations, and creating custom snap-ins. Start your journey by going through the [entities](/pages/entities) page, where you can get familiar with the basic concepts and terminologies used in the API documentation. 
...
You’re all set to explore our platform. Go through the [entities](/pages/entities) page, where you can get familiar with the basic concepts and terminologies used in the API documentation. Visit [methods page](https://devrev.ai/docs/apis/methods) to browse through our APIs and build your first integration with DevRev.